...
export default class PayPal extends React.Component {
  render() {
    ...
    const myTotal = this.props.myTotal

    let env = "sandbox" // you can set this string to 'production'
    let currency = "USD" // you can set this string from your props or state
    let total = myTotal // this is the total amount (based on currency) to charge
    // Document on Paypal's currency code: https://developer.paypal.com/docs/classic/api/currency_codes/

    const client = {
      sandbox:
        "AcJG1zCUcXJrBKTtf6Ha5duKS1SxKWiQRitm3f3M6be5arUcuyVyxP1ZV-WogDnsXjQw2SyMvjuAErtf",

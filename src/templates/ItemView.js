...
const ItemView = props => {
  ...
  return (
    <>
      <CartLink />
      {/* <div
        className="py-2 flex flex-1 flex-col
      md:flex-row
      w-full
      my-0 mx-auto"
      >
        <div className="w-full md:w-1/2 h-112 flex flex-1 bg-light hover:bg-light-200 mx-1 my-1">
      ...
      >
        <div className="w-full md:w-1/2 h-112 flex flex-1 bg-light hover:bg-light-200 mx-1 my-1">
          <div className="py-16 p10 flex flex-1 justify-center items-center">
            <Image
              src={image}
              className="max-w-xl m-0 max-h-96 w-64 md:w-full"
              alt="Inventory item"
            />
          </div>
        </div>
